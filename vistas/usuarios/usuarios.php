        ...
        <div class="left-panel">
            ...
            <form id="formRegistroUsuario">
                <div class="form-section">
                    ...
                    <!-- Nombre de usuario -->
                    <div class="form-group">
                        <label class="form-label" for="idusuario">
                            Nombre de usuario <span class="required">*</span>
                        </label>
                        <input type="text" class="form-input" id="idusuario" placeholder="Ej: Dani" required>
                    </div>

                    <!-- Contraseña -->
                    <div class="form-group">
                        <label class="form-label" for="idpassword">
                            Contraseña <span class="required">*</span>
                        </label>
                        <input type="password" class="form-input" id="idpassword" required>
                    </div>
